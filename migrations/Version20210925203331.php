 ...
 */
final class Version20210925203331 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE pronostic ADD archived TINYINT(1) DEFAULT NULL, ADD updated DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE Pronostic DROP archived, DROP updated');
