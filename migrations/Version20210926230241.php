 ...
 */
final class Version20210926230241 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE pronostic ADD isChecked TINYINT(1) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE Pronostic DROP isChecked');
