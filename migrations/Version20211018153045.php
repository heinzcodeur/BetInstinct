 ...
 */
final class Version20211018153045 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE athlete ADD genre ENUM(\'homme\',\'dame\')');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE Athlete DROP genre');
