 ...
 */
final class Version20210910111218 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE jeu ADD created_at DATETIME DEFAULT NULL, ADD updated_at DATETIME DEFAULT NULL');
